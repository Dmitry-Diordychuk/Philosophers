...
/*   Updated: 2021/03/29 22:49:49 by kdustin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	mprint(u_int64_t start_time, int id, char *action)
{
	...
	if (start_time == 1 && id == -1 && action == NULL)
		if (pthread_mutex_init(&mutex, NULL))
			return (MUTEX_ERROR);
	if (start_time == 2 && id == -2 && action == NULL)
